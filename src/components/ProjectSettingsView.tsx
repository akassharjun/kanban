...
import type { Project, Status, Label, IssueTemplate, Hook, ProjectAgentConfig, Epic, MilestoneWithProgress } from "@/types";
...
type Tab = "general" | "statuses" | "labels" | "epics" | "milestones" | "templates" | "hooks" | "agents";
...
export function ProjectSettingsView({ project, onUpdateProject, onRefreshStatuses, onRefreshLabels, onRefreshEpics, onRefreshMilestones, onDeleteProject: _onDeleteProject }: ProjectSettingsViewProps) {
  ...
  const loadData = async () => {
    const [s, l, t, h, ac, ep, ms] = await Promise.all([
