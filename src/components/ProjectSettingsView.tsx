...
import { Plus, Pencil, Trash2, X, Zap, Play, Pause, ChevronDown, ChevronUp, Clock, CheckCircle2, XCircle, AlertTriangle, Loader2, RefreshCw, GitBranch } from "lucide-react";
...
export function ProjectSettingsView({ project, onUpdateProject, onRefreshStatuses, onRefreshLabels, onRefreshEpics, onRefreshMilestones, onDeleteProject: _onDeleteProject }: ProjectSettingsViewProps) {
  ...
  const loadData = async () => {
    const [s, l, t, h, ac, m, ep, ms, ar, al, ghc] = await Promise.all([
